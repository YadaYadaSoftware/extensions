...
public static class ILoggerFactoryExtensions
{
    ...
    public static ILoggerFactory AddLoggerYadaYada(this ILoggerFactory factory)
    {
        var options = new LambdaLoggerOptions();
        return AddLoggerYadaYada(factory, options);
    }
    ...
    /// <returns>Updated ILoggerFactory.</returns>
    public static ILoggerFactory AddLoggerYadaYada(this ILoggerFactory factory, LambdaLoggerOptions options)
    {
        if (factory == null)
        {
    ...
    /// <returns>Updated ILoggerFactory.</returns>
    public static ILoggerFactory AddLoggerYadaYada(this ILoggerFactory factory, IConfiguration configuration)
    {
        if (factory == null)
        {
            throw new ArgumentNullException(nameof(factory));
    ...
    /// <returns>Updated ILoggerFactory.</returns>
    public static ILoggerFactory AddLoggerYadaYada(this ILoggerFactory factory, IConfiguration configuration, string loggingSectionName)
    {
        if (factory == null)
        {
            throw new ArgumentNullException(nameof(factory));
