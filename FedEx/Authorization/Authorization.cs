...
namespace FedEx.Authorization
{
    ...
    public partial class Client 
    {
        ...
        public virtual System.Threading.Tasks.Task<Response> OauthTokenAsync(string content_type, FullSchema body)
        {
            return OauthTokenAsync(content_type, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Response> OauthTokenAsync(string content_type, FullSchema body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
    ...
    {
        /// <summary>
        /// Specify the type of customer requesting the Oauth token.&lt;br&gt;Valid Values: client_credentials, csp_credentials&lt;br&gt;Note:&lt;br&gt;client_credentials - should be used for customers.&lt;br&gt;csp_credentials - should be used for Compatible Provider customers.
        /// </summary>
        ...
        /// <summary>
        /// Specify the Client ID also known as Customer Key. This element is used as a login credential for a Compatible Customer to access the application on behalf of their customer.&lt;br&gt;Example: XXXX-XXX-XXXX-XXX&lt;br&gt;Note: This element should only be used by Compatible Customers.
        /// </summary>
        ...
        /// <summary>
        /// Specify the Client secret also known as Customer Secret. This element is used as a login credential for a Compatible Customer to access the application on behalf of their customer.&lt;br&gt;Example: XXXX-XXX-XXXX-XXX&lt;br&gt;Note: This element should only be used by Compatible Customers.
        /// </summary>
